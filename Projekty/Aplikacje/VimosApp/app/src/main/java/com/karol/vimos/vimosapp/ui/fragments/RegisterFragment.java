...
import com.karol.vimos.vimosapp.core.registration.RegisterPresenter;
import com.karol.vimos.vimosapp.core.users.add.AddUserContract;
import com.karol.vimos.vimosapp.core.users.add.AddUserPresenter;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private void onRegister(View view) {
        ...
        String password = mETxtPassword.getText().toString();
                ...
                mRegisterPresenter.register(getActivity(), emailId, password, mProgressDialog);
    ...
    public void onAddUserSuccess(String message) {
        ...
        NickActivity.startActivity(getActivity(),
