...
/**
 * Created by Vimos on 23/02/17.
 */

public class BlueLector extends BlueActivity implements MediaPlayer.OnErrorListener {
...
//        }
        ...
        else if (distanceToTheNearest == 800) {
        ...
        else if (distanceToTheNearest == 700) {
        ...
        else if (distanceToTheNearest == 600) {
        ...
        else if (distanceToTheNearest == 500) {


            pl_500.start();
            pl_500.setLooping(false);
        }
        else if (distanceToTheNearest == 400) {
        ...
        else if (distanceToTheNearest == 300) {
        ...
        else if (distanceToTheNearest == 200) {
        ...
        else if (distanceToTheNearest >= 40 && distanceToTheNearest <= 80) {
...
//        }
    ...
    public static void plSpeakDistanceToTheNearestRed(Context context, int distanceToTheNearest, int speed, int volume) {
        ...
        MediaPlayer [] listMediaPlayer;
        listMediaPlayer = new MediaPlayer[] {pl_10, pl_20, pl_40, pl_60, pl_80, pl_100, pl_200, pl_300, pl_400, pl_500,
                pl_600, pl_700, pl_800, pl_900, pl_close, pl_slowdown, train_alert};

        // set mute (volume = 0) or unmute (volume = 1) all MediaPlayer s objects
        for (MediaPlayer aListMediaPlayer : listMediaPlayer) {
        ...
        else if (distanceToTheNearest > 720 && distanceToTheNearest < 780) {

            train_alert.start();
            train_alert.setLooping(false);
        ...
        else if (distanceToTheNearest > 520 && distanceToTheNearest < 580) {
...
//        }
    ...
    public static void enSpeakDistanceToTheNearest(Context context, Float distanceToTheNearest) {

        MediaPlayer en_500, en_50, en_20, en_10, en_100;

        en_500 = MediaPlayer.create(context, R.raw.en_500);
        en_100 = MediaPlayer.create(context, R.raw.en_100);
        en_50 = MediaPlayer.create(context, R.raw.en_50);
        en_20 = MediaPlayer.create(context, R.raw.en_20);
        en_10 = MediaPlayer.create(context, R.raw.en_10);


        if (distanceToTheNearest > 900 && distanceToTheNearest < 1000) {


        }

        else if (distanceToTheNearest > 800 && distanceToTheNearest < 900) {

            en_500.start();

        }

        else if (distanceToTheNearest > 700 && distanceToTheNearest < 800) {


        }

        else if (distanceToTheNearest > 600 && distanceToTheNearest < 700) {


        }

        else if (distanceToTheNearest > 500 && distanceToTheNearest < 600) {


        }

        else if (distanceToTheNearest > 400 && distanceToTheNearest < 500) {


        }

        else if (distanceToTheNearest > 300 && distanceToTheNearest < 400) {


        }

        else if (distanceToTheNearest > 200 && distanceToTheNearest < 300) {


        }

        else if (distanceToTheNearest > 100 && distanceToTheNearest < 200) {

            if (distanceToTheNearest < 180 && distanceToTheNearest > 110) {

                en_100.start();

                // play: object will be in 150 meters.
            }

        }

        else if (distanceToTheNearest > 50 &&distanceToTheNearest < 100) {

            // play object will be in 50 meters
            en_50.start();

        }

        else if (distanceToTheNearest > 0 && distanceToTheNearest < 50) {

            if (distanceToTheNearest > 40) {
            ...
            if (distanceToTheNearest > 30 && distanceToTheNearest < 40) {
            ...
            if (distanceToTheNearest > 20 && distanceToTheNearest < 30) {

                //  pl_30.stop();
                en_20.start();
                en_10.setLooping(false);

                // play: 20 meters.
            }

            if (distanceToTheNearest > 10 && distanceToTheNearest < 20) {
            ...
            if (distanceToTheNearest < 10) {

                // play: Object too close. Object too close.
                // pl_close.start();
...
// REMEMBER!
// if blue is in the same position during some time -> the lector still works. so implement method that
// if blue doesnt change some position lector is calling for every 10 seconds for example.