...
import com.karol.vimos.vimosapp.core.users.get.all.GetUsersContract;
import com.karol.vimos.vimosapp.core.users.get.all.GetUsersPresenter;
import com.karol.vimos.vimosapp.models.User;
import com.karol.vimos.vimosapp.ui.activities.ChatRedActivity;
import com.karol.vimos.vimosapp.ui.adapters.UserListingRecyclerAdapter;
import com.karol.vimos.vimosapp.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ChatRedActivity.startActivity(getActivity(),
                mUserListingRecyclerAdapter.getUser(position).email, // it shows in chatFragment email on toolbar at the top.
    ...
    public void onDestroy() {
        ...
        Log.e("   USERS_FRAGMENT   ", "on    Destroy");
    }
}
