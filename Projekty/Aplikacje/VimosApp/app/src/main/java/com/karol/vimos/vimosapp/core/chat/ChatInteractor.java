package com.karol.vimos.vimosapp.core.chat;
...
import com.karol.vimos.vimosapp.fcm.FcmNotificationBuilder;
...
public class ChatInteractor implements ChatContract.Interactor{
    ...
    @Override
    public void deleteConversationFromFirebaseUser(String senderUid, String receiverUid) {
