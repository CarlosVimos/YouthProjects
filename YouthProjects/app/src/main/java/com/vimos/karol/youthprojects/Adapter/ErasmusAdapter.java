 ...
 */
public class ErasmusAdapter extends RecyclerView.Adapter<ErasmusAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            this.view = view;
            title = (TextView) view.findViewById(R.id.list_erasmus_title);
            place = (TextView) view.findViewById(R.id.list_erasmus_place);
            date = (TextView) view.findViewById(R.id.list_erasmus_date);
        }
    }

    public ErasmusAdapter(OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_erasmus, parent, false);
