...
import com.vimos.karol.youthprojects.Adapter.OthersAdapter;
import com.vimos.karol.youthprojects.Model.YouthProject;

public class OthersActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (RecyclerView) findViewById(R.id.list_others);
        adapter = new OthersAdapter(this);
        ...
        reference = database.getReference("others");
