...
import com.vimos.karol.youthprojects.Adapter.LastMinuteAdapter;
import com.vimos.karol.youthprojects.Model.YouthProject;

public class LastMinuteActivity extends AppCompatActivity implements OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (RecyclerView) findViewById(R.id.list_lastminute);
        adapter = new LastMinuteAdapter(this);
        ...
        reference = database.getReference("lastminute");
