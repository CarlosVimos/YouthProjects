...
import com.vimos.karol.youthprojects.Adapter.EVSAdapter;
import com.vimos.karol.youthprojects.Adapter.ErasmusAdapter;
import com.vimos.karol.youthprojects.Model.YouthProject;

public class EVS_Activity extends AppCompatActivity implements OnItemClickListener {

    private EVSAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evs_);
        ...
        listView = (RecyclerView) findViewById(R.id.list_evs);
        adapter = new EVSAdapter(this);
        ...
        reference = database.getReference("evs");
