...
public class Erasmus_Activity extends AppCompatActivity implements OnItemClickListener {

    private ErasmusAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_erasmus_);
        ...
        listView = (RecyclerView) findViewById(R.id.list_erasmus);
        adapter = new ErasmusAdapter(this);
        ...
        reference = database.getReference("erasmus");
