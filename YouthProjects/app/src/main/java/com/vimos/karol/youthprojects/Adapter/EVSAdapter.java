 ...
 */
public class EVSAdapter extends RecyclerView.Adapter<EVSAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            this.view = view;
            title = (TextView) view.findViewById(R.id.list_evs_title);
            place = (TextView) view.findViewById(R.id.list_evs_place);
            date = (TextView) view.findViewById(R.id.list_evs_date);
        }
    }

    public EVSAdapter(OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_evs, parent, false);
