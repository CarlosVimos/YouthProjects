...
import com.vimos.karol.youthprojects.Adapter.ConferencesAdapter;
import com.vimos.karol.youthprojects.Model.YouthProject;

public class Conferences_Activity extends AppCompatActivity implements OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conferences_);
        ...
        listView = (RecyclerView) findViewById(R.id.list_conferences);
        adapter = new ConferencesAdapter(this);
        ...
        reference = database.getReference("conferences");
